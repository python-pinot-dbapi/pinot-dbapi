...
## docker run --name pinot-quickstart -p 2123:2123 -p 9000:9000 -p 8000:8000 -d apachepinot/pinot:latest QuickStart -type AUTH-ZK
conn = connect(host="localhost", port=8000, path="/query/sql", scheme="http", username="admin", password="verysecret")
curs = conn.cursor()
...
engine = create_engine(
    "pinot://admin:verysecret@localhost:8000/query/sql?controller=http://localhost:9000/"
